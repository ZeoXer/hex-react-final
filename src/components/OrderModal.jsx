...
import { editOrderById } from "../api/functions";

const OrderModal = ({ closeProductModal, fetchOrders, tempOrder }) => {
  ...
  const handleChange = (e) => {
    ...
    if (["is_paid"].includes(name)) {
      setTempData({ ...tempOrder, [name]: checked });
    } else {
      setTempData({ ...tempOrder, [name]: value });
    }
  };
